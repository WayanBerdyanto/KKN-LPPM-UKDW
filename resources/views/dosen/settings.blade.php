            ...
            <div class="grid grid-cols-5 gap-8">
                <div class="col-span-5 xl:col-span-3">
                    <div
                        ...
                        <div class="p-7">
                            <form action="/dosen/updateprofile">
                                @csrf
                ...
                <div class="col-span-5 xl:col-span-2">
                    <div
                        ...
                        <div class="p-7">
                            <form action="/dosen/uploadfoto" enctype="multipart/form-data" method="POST">
                                @csrf
                    ...
                    <div class="pt-4">
                        <div
                            ...
                            <div class="p-7">
                                <form action="/dosen/gantipassword" onsubmit="return validateForm()">
                                    <div class="mb-5.5">
                                        <label
