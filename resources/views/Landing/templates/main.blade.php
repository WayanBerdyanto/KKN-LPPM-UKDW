...
<body>
    ...
    <div id="spinner" class="spinner-container">
        <svg role="status" class="inline h-14 w-14 animate-spin mr-2 text-gray-200 dark:text-gray-600 fill-blue-600"
    ...
    <script src="{{ asset('js/animationScroll.js') }}" defer></script>
</body>
