...
<body x-data="{ modalOpen: false, 'darkMode': true, 'loaded': true, 'sidebarToggle': false, 'modalLogbook': false, 'modalkegiatan': false, 'modalDetailLogbook': false, 'modalUpdateLogbook': false, 'modalupdatekegiatan':false, 'modaldetailrencana':false,'modalUpdateLaporan':false,'modalLaporan':false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
