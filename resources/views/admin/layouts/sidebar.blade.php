<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="h-full px-2 py-4 overflow-y-auto bg-boxdark border-r-2 border-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li class="pt-5">
                <a href="/admin/semesteraktif"
                    class="flex items-center p-2 text-secondary rounded-lg  group {{ $key == 'semesteraktif' ? 'bg-primary' : 'hover:bg-gray-600' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Semester Aktif</span>
                </a>
            </li>
            <li class="pt-5">
