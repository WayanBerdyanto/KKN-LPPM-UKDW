...
<body x-data="{ modalOpen: false, 'darkMode': true, 'loaded': true, 'sidebarToggle': false, 'modalSemester': false, 'modalUpdate': false,'modalDetail':false ,'modalJenis':false ,'modalUpdateJenis':false}">
