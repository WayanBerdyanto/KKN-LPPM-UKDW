                        ...
                        <tr class="bg-white border-b border-slate-200 hover:bg-slate-50 ">
                            ...
                            <td scope="row" class="px-2 py-4 max-w-36 truncate">
                                @if ($item->komentar_admin != null)
                                    ...
                                    <a href="#"
                                        onclick="confirmDelete('/admin/deletekomentarlaporan/{{ $item->id_laporan }}')"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.insertKomentarLaporan').click(function() {
                ...
                $('form').attr('action', '/admin/laporan/postkomentarlaporan/' + id_laporan);
                $.ajax({
                    url: "/admin/detaillaporan/" + id_laporan,
                    method: "GET",
                    dataType: "json"
                });
            });
