...
@section('content')
    ...
    <h2 class="flex items-center text-2xl font-medium text-gray-700 sm:text-2xl text-boxdark">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-columns mr-2 font-semibold"
            viewBox="0 0 16 16">
                    ...
                    <tr class="odd:bg-secondary even:bg-gray-200 text-dark">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <button @click="modalJenis = true" data-toggle="modal" data-target="#formModal"
            ...
            <form action="/admin/postjenis" method="POST">
                ...
                <div class="mb-4.5">
                    ...
                    <div class="relative z-20 bg-transparent dark:bg-form-input">
                        <select name="kode_semester" x-model="selectedKodeSemester"
