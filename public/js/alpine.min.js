(() => {
  ...
  `
    ...
    function cn(e, t, r) {
        ...
        t.includes("in") &&
            !n &&
            (t = t.filter((_, x) => x < t.indexOf("out"))),
            t.includes("out") &&
                !n &&
                (t = t.filter((_, x) => x > t.indexOf("out")));
    ...
    b(
        "refs",
        (e) => (
            e._x_refs_proxy || (e._x_refs_proxy = N(zn(e))), e._x_refs_proxy
        )
    );
    function zn(e) {
        let t = [],
    ...
    function ei(e, t) {
        ...
        if (r.includes("debounce")) {
            ...
            r.splice(
                o,
                vt((r[o + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1
            );
        }
    ...
    function oi(e, t, r, n) {
        ...
        n(() => {
            for (; o.length; ) o.pop()();
            i((s) => {
                let a = Object.entries(s).map(([l, u]) => ({
                    name: l,
                    value: u,
                }));
                a = a.filter(
        ...
        r((s) => {
            ...
            if (i(s))
                s = Object.entries(s).map(([f, _]) => {
                    let x = Kr(t, _, f, s);
                    n((R) => u.push(R), { scope: { index: f, ...x } }),
                        l.push(x);
                });
            else
                for (let f = 0; f < s.length; f++) {
                    let _ = Kr(t, s[f], f, s);
                    n((x) => u.push(x), { scope: { index: f, ..._ } }),
                        l.push(_);
                }
            let d = [],
                y = [],
